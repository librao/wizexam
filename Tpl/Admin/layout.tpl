...
<html lang="en">
    <head>
        ...
        <link href="__PUBLIC__/css/google-code-prettify/prettify.css" rel="stylesheet">
    	<link href="__PUBLIC__/css/nivo-slider.css" type="text/css" media="screen" rel="stylesheet">
        <link href="__PUBLIC__/css/prettyPhoto.css" type="text/css" media="screen" rel="stylesheet">
                ...
                <section>
                    <footer>
                        <div class="row">
                            ...
                            <div class="span3">
                                <p>Copyright &copy; <a href="http://raoliping.cn/my_blog/" target="_blank">立播网</a> - 2013  Powered by <strong>lib-rao</strong></p>
                            </div>
                            <div class="span6">
...
<!--
    ...
    <script type="js/contact.js"></script>
